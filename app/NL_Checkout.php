...
*   Người dùng không thể tự động sửa được ລາຄາ trị tham số giao tiếp giữa website của bạn và NgânLượng.vn nếu như không biết chính xác tham số bạn đã lưu và mật khẩu giao tiếp là gì.
**/
...
class NL_Checkout
{
  ...
  // Mã website của bạn ລົງທະບຽນ trong chức năng tích hợp thanh toán của NgânLượng.vn.
   ...
   * @param string $order_code: Mã hoá đơn hoặc tên ສິນຄ້າ
   * @param int $price: Tổng tiền hoá đơn/ສິນຄ້າ, chưa kể phí vận chuyển, giảm ລາຄາ, thuế.
   * @param string $currency: ປະເພດ tiền tệ, nhận một trong các ລາຄາ trị 'vnd', 'usd'. Mặc định đồng tiền thanh toán là 'vnd'
   * @param int $quantity: Số lượng ສິນຄ້າ
   * @param int $tax: Thuế
   * @param int $discount: Giảm ລາຄາ
   * @param int $fee_cal: Nhận ລາຄາ trị 0 hoặc 1. Do trên hệ thống NgânLượng.vn cho phép chủ tài khoản cấu hình cho nhập/thay đổi phí lúc thanh toán hay không. Nếu website của bạn đã có phí vận chuyển và không cho sửa thì đặt tham số này = 0
   * @param int $fee_shipping: Phí vận chuyển
   * @param string $order_description: Mô tả về ສິນຄ້າ, đơn hàng
   ...
   * @param string $receiver: Địa chỉ Email chính của tài khoản NgânLượng.vn của người bán dùng nhận tiền bán hàng
   * @param string $transaction_info: Tham số bổ sung, bạn có thể dùng để lưu các tham số tuỳ ý để cập nhật thông tin khi NgânLượng.vn trả kết quả về
   * @param string $order_code: Mã hoá đơn/Tên ສິນຄ້າ
   ...
   *
   * @param string $transaction_info: Thông tin về giao dịch, ລາຄາ trị do website gửi sang
   * @param string $order_code: Mã hoá đơn/tên ສິນຄ້າ
