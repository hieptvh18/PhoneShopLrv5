      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 col-xs-6 col-ssm">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              ...
              <p><b><i class="fas fa-envelope"></i> Email:</b> <a href="dienthoaigiakho@gmail.com" rel="nofollow">dienthoaigiakho@gmail.com</a></p>
        ...
        <div class="col-md-3 hidden-sm hidden-xs">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              <ul>
                <li><a href="http://localhost:81/DienThoaiGiaKho/public/posts" title="Chính sách bảo hành">Chính sách bảo hành</a></li>
           ...
           <div class="widget-content">
              <ul>
                <li class="clearfix">
                  ...
                  <li><a href="https://forms.gle/z4a2B9tV2UGERdfU6" title="ແຊັດເລີຍ">Liên hệ</a></li>
                </li>
                <li>
