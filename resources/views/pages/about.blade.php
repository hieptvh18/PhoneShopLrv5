  ...
  <div class="site-about">
    ...
    <section class="section-about">
      <div class="section-header">
        <h2 class="section-title">ກ່ຽວກັບ</h2>
      </div>
            ...
            <div class="content-left">
              <div class="note">
                ...
                <div class="note-content">
                  <p>website <strong>PhoneShop</strong> là một ສິນຄ້າ của đồ án tốt nghiệp đề tài: <i>Thiết kế website bán điện thoại</p>
                </div>
              </div>
              <div class="content">
                <p>PhoneShop là trang web chuyên bán điện thoại được nhập chính hãng từ nhà sản xuất hàng đầu thế giới như: Apple, Samsung, Oppo, Xiaomi, Huawei, Asus...
...
Chính vì thế việc mua sắm online càng trở nên quan trọng và cần thiết,chỉ cần 1 cú click chuột thì họ có thể có được ສິນຄ້າ mà mình mong muốn.Việc mua sắm online có nhiều ưu điểm là có thể sở hữu mọi thứ thông qua các cú click chuột chứ không cần phải đến tận nơi để mua hàng. Sau khi vào website bán hàng, chọn ສິນຄ້າ, chỉ cần đặt hàng (order) người bán sẽ mang ສິນຄ້າ đến tận nhà bạn. Mua sắm online cho phép mua hàng bất cứ khi nào bạn muốn. Các cửa hang trên mạng không bao giờ đóng cửa, có thể mua sắm 24/24 giờ và 7 ngày trong tuần. Mua sắm ở các chợ, trung tâm thương mại hay cửa hàng rất khó để bạn có thể so sánh đặc điểm và ລາຄາ của ສິນຄ້າ với nhau. Khi mua hàng online, bạn dễ dàng so sánh và đưa ra lựa chọn ສິນຄ້າ phù hợp nhất. Đôi khi bạn gặp phải những người bán hàng khó tính tại một số địa điểm bán hàng. Mua sắm online thì khách hàng chẳng phải để ý đến chuyện ấy nữa.
                </p>
              </div>
            </div>
          </div>
